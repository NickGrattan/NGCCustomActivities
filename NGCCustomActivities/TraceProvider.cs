...
namespace NGCCustomActivities
{
    static class TraceProvider
    {
        ...
        public static void TraceException(string category, string message)
        {
            ...
            TraceProvider.WriteTrace(0, TraceProvider.TraceSeverity.High, Guid.Empty, "NGCCustomActivities", "NGCCustomActivities", category, message);
        ...
        {
            TraceProvider.RegisterTraceProvider();
            TraceProvider.WriteTrace(0, TraceProvider.TraceSeverity.WarningEvent, Guid.Empty, "NGCCustomActivities", "NGCCustomActivities", category, message);
            TraceProvider.UnregisterTraceProvider();
        }
